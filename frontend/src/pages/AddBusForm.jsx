...
import {
    Bus, MapPin, Clock, Hash, User, DollarSign, Type, Sofa, Wifi, Tv2, PlugZap, Popcorn, CalendarDays, PlusCircle
} from "lucide-react";
...
const AddBusForm = () => {
    ...
    return (
        ...
        //         {/* Name, From, To, Time, Seats, Price, BusNumber */}
        //         {["name", "from", "to", "time", "seats", "price", "busNumber"].map(field => (
        //             <div key={field}>
        //                 <label className="block mb-1 text-gray-700 capitalize font-medium" htmlFor={field}>
        //                     {field === "name" ? "Bus Name" : field}
        //                 </label>
        //                 <input
        //                     type={field === "seats" || field === "price" ? "number" : field === "time" ? "time" : "text"}
        //                     name={field}
        //                     id={field}
        ...
        //         {/* Seat Type */}
        //         <div>
        //             <label className="block mb-1 text-gray-700 font-medium">Seat Type:</label>
        //             <select
        //                 name="seatType"
        ...
        //         {/* Duration */}
        //         <div>
        //             <label className="block mb-1 text-gray-700 font-medium" htmlFor="duration">Duration:</label>
        //             <input
        //                 type="text"
        //                 name="duration"
        //                 id="duration"
        ...
        //         {/* Days of Operation */}
        //         <div>
        //             <label className="block mb-1 text-gray-700 font-medium">Days of Operation:</label>
        //             {daysOptions.map((day) => (
        //                 <label key={day} className="block text-gray-600">
        //                     <input
        //                         type="checkbox"
        ...
        <div className="max-w-5xl mx-auto bg-white p-8 rounded-xl shadow-md mt-10">
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                    {/* Basic Inputs */}
                    {[
                        { icon: Type, label: "Bus Name", name: "name", type: "text", placeholder: "e.g. Express Deluxe" },
                        { icon: MapPin, label: "From", name: "from", type: "text" },
                        { icon: MapPin, label: "To", name: "to", type: "text" },
                        { icon: Clock, label: "Departure Time", name: "time", type: "time", placeholder: "e.g. 02:00" },
                        { icon: Sofa, label: "Seats", name: "seats", type: "number", placeholder: "e.g. 30" },
                        { icon: DollarSign, label: "Price", name: "price", type: "number", placeholder: "e.g. 1000" },
                        { icon: Hash, label: "Bus Number", name: "busNumber", type: "text", placeholder: "e.g. VBUS001" },
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-2 flex items-center gap-1">
                            <CalendarDays className="w-4 h-4 text-blue-500" /> Days of Operation
                        </label>
                        <div className="grid grid-cols-2 gap-2">
                            {daysOptions.map(day => (
